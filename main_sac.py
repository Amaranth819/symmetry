...
def read_parser():
    ...
    parser.add_argument('--env_id', type = str, default = 'SymmetricHumanoidEnv-v2')
    ...
    parser.add_argument('--log_path', type = str, default = 'SymmetricHumanoidEnv-v2-noalphatuning/')
...
if __name__ == '__main__':
    ...
    record_video_with_policy(config.log_path, use_final_policy = True, use_best_policy = False)